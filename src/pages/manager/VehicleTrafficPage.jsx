          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-indigo-500/30">
                <p className="text-indigo-100 text-xs font-bold uppercase tracking-widest mb-2">Tổng lượt gửi xe</p>
                <h4 className="text-3xl font-black">
                  {new Intl.NumberFormat("vi-VN").format(visitsData.totalSessions || 0)}
                  <span className="text-xl text-indigo-200 font-bold ml-1">lượt</span>
                </h4>
